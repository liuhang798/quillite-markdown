...
- “AI编辑”支持润色、改写、精简、扩写、总结、翻译和自定义要求，提供生成进度、结果预览与可撤销替换；“AI检查”可检查整篇 Markdown，并逐条选择、一次应用语法、拼写、标点、表达和格式建议。
